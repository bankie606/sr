...
The result of a StreamReduce computation is sensitive to the properties of the input
and the the properties of the transformation applied.
...
substituting computation algorithms. Certain combinations of inputs and transformations
may be able to withstand this additional noise while other combinations of inputs and
...
%Gaps in the hundreds are stable in the
...
data-discarding transformations that StreamReduce employs.
