...
trends or results. Google runs PageRank on the entire Internet, but if
...
discarding data randomly. On the subset of data that I do process, I explore using
...
The goal of Sr is to be a MapReduce-style framework for processing streams. Such a
framework should include the ability to kill or discard tasks and provide serveral
different computation routines for workers to choose among.
...
exporter~\cite{wikipedia:pecial:export} on January 9, 2012.
